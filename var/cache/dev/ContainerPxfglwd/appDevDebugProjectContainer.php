...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JwoFKdq1qZ', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ehCQgHyrnr', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'beststor_version17', 'user' => 'beststor_jfernandez', 'password' => 'O1MGZmMYLP!(', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_c0eccf3585cfee0c7c2850fcd9581753acb2c0862f1ae7e51bba2ddc3331bdfa');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('omdngxF2Pg', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k1qE6kCu66', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rVV2pzRs7T', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('XWRw70Fk48IRv3aXHa5c1JZsw0z4PkV0RKpYnrq9Dt147y3ITcT33W3x');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.active_modules' => array(
                ...
                66 => 'wtmanufacture',
                67 => 'wtpagetitle',
                68 => 'wtproductcategory',
                69 => 'wtproductcomments',
                70 => 'wtproductfilter',
                71 => 'wtslideshow',
                72 => 'wtsizeguide',
                73 => 'wtspecials',
                74 => 'wtsubcategory',
                75 => 'wtthemeconfigurator',
                76 => 'wtverticalmegamenu',
                77 => 'webpay',
                78 => 'supercheckout',
                79 => 'khipupayment',
                80 => 'swachilexpress',
                81 => 'ps_googleanalytics',
                82 => 'ps_emailsmanager',
            ),
            ...
            'database_user' => 'beststor_jfernandez',
            'database_password' => 'O1MGZmMYLP!(',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'XWRw70Fk48IRv3aXHa5c1JZsw0z4PkV0RKpYnrq9Dt147y3ITcT33W3x',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-10-02',
            'locale' => 'es-ES',
            'cookie_key' => 'GafAgLNPEv0BadDRz3XoFgSIjhruITzzdNH5stRWEDm82hKnM9D7aiJ7',
            'cookie_iv' => 'D50s8q00',
            'new_cookie_key' => 'def0000060ba4d6c726a238ca9908e667ac10aac5abdec6042e5396449501381a4fdd43cc647fe5ab572fbe714d793857340e6caf380f15c097acd96160a26509bb4b0cf',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'XWRw70Fk48IRv3aXHa5c1JZsw0z4PkV0RKpYnrq9Dt147y3ITcT33W3x',
