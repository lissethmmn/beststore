<?php
/* Smarty version 3.1.32, created on 2018-10-08 18:41:13
  from '/home/beststor/public_html/version17/modules/wtproductfilter/views/templates/hook/thumbnail_special.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5bbbcef93692d5_32863081',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '271f696a033ada603b46e9087bb32dd59a2391ee' => 
    array (
      0 => '/home/beststor/public_html/version17/modules/wtproductfilter/views/templates/hook/thumbnail_special.tpl',
      1 => 1538503565,
      2 => 'file',
    ),
  ),
...
function content_5bbbcef93692d5_32863081 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="thumbs_list_frame" name="thumb-images-special-<?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['product']->value['id_product']), ENT_QUOTES, 'UTF-8');?>
">
				<?php
...
"<?php if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_thumbnails']->value['last']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_thumbnails']->value['last'] : null)) {?> class="last"<?php }?>>
						<a wt_rel="prettyPhoto[thumb-images-special-<?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['product']->value['id_product']), ENT_QUOTES, 'UTF-8');?>
]"
...
" tv-img-src="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['imageIds']->value,'large_default'),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
"
...
">
							...
							<img class="img-responsive lazy lazy_ajax" id="thumb_<?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['product']->value['id_product']), ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['image']->value['id_image'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
" data-original="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['imageIds']->value,'small_default'),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
modules/wtproductcategory/views/img/empty-lazy.gif" alt="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['imageTitle']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
