...
<div class="item product-box js-product-miniature" data-id-product="{$product.id_product|escape:'quotes':'UTF-8'}" data-id-product-attribute="{$product.id_product_attribute|escape:'quotes':'UTF-8'}">
					...
					<div class="product-container">	
							...
							{hook h='displayProductListFunctionalButtons' product=$product}
								...
								<h5 class="product-name"><a href="{$product.link|escape:'html':'UTF-8'}">{$product.name|truncate:25:''|escape:'html':'UTF-8'}</a></h5>
