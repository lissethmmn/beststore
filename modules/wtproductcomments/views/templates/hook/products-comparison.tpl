...
<tr class="comparison_header">
	<td>
		{l s='Comments' mod='wtproductcomments'}
	</td>
...
{/foreach}
	...
	{cycle values='comparison_feature_odd,comparison_feature_even' assign='classname'}
<tr>
	<td  class="{$classname|escape:'html':'UTF-8'} comparison_infos">{l s='Average' mod='wtproductcomments'}</td>
{foreach from=$list_ids_product item=id_product}
...
<tr>
	...
	<td  width="{$width|escape:'html':'UTF-8'}%" class="{$classname|escape:'html':'UTF-8'} comparison_infos" align="center" >
		...
		<a href="#" rel="#comments_{$id_product|escape:'html':'UTF-8'}" class="cluetip">{l s='view comments' mod='wtproductcomments'}</a>
