...
// Include Module
include_once(dirname(__FILE__).'/../../wtproductcomments.php');
// Include Models
include_once(dirname(__FILE__).'/../../class/ProductComment.php');
include_once(dirname(__FILE__).'/../../class/ProductCommentCriterion.php');

class WTProductCommentsDefaultModuleFrontController extends ModuleFrontController
{
	...
	{
		$module_instance = new WTProductComments();
