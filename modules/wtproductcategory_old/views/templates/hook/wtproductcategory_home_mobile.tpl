...
<div class="wt-prod-cat clearfix" id="wt-prod-cat-base-ssl" wt_base_ssl="{$base_dir_ssl|escape:'quotes':'UTF-8'}modules/wtproductcategory/controller_ajax_cat_mobile.php">
