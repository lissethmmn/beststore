...
class WtBlockSearch extends Module implements WidgetInterface
{
	...
	public function install()
	{
		...
		if (!parent::install() || !$this->registerHook('displayTopSearch') || !$this->registerHook('header') || !$this->registerHook('displayMobileTopSiteMap'))
			return false;
		return true;
	}
	...
	public function hookHeader($params)
	{
		...
		$this->context->controller->addCss($this->_path.'views/css/wtsearch.css');
