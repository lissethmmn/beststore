...
class WTBlockWishListViewModuleFrontController extends ModuleFrontController
{
	...
	public function __construct()
	{
		...
		include_once($this->module->getLocalPath().'wtblockwishlist.php');
	}
	...
	public function initContent()
	{
		...
		$this->setTemplate('module:wtblockwishlist/views/templates/front/view.tpl');
	}
}
