...
if ($context->customer->isLogged())
{
	...
	if (empty($id_wishlist) === false)
	{
		...
		else
		{
			...
			if (Tools::file_exists_cache(_PS_THEME_DIR_.'modules/wtblockwishlist/views/templates/front/managewishlist.tpl'))
				$context->smarty->display(_PS_THEME_DIR_.'modules/wtblockwishlist/views/templates/front/managewishlist.tpl');
