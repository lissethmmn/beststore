...
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Menu Item' mod='wtmegamenu'}</h3>
	<div class="form-wrapper" id="menuContent" >
		...
		<div class="form-group wt-fw-icon" {if $menu->type_icon == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Material Icons' mod='wtmegamenu'}</label>
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Material icons at :' mod='wtmegamenu'} <a target="_blank" href="https://material.io/icons/">https://material.io/icons/</a> ex: home</p>
			</div>
		</div>
					...
					<div class="dummyfile input-group">
						...
						<span class="input-group-btn">
							<button id="icon_img-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
								<i class="icon-folder-open"></i> {l s='Add file' mod='wtmegamenu'}				</button>
										</span>
					</div>
