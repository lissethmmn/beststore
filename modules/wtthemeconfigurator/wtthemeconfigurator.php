...
class WtThemeConfigurator extends Module
{
	...
	public function hookdisplayHeader()
	{
		...
		$this->context->controller->addCss($this->_path.'views/css/frontend/cloud-zoom.css');
		$this->context->controller->addCss($this->_path.'views/css/frontend/prettyPhoto.css');
		...
		$this->context->controller->addJs($this->_path.'views/js/frontend/cloud-zoom.1.0.2.min.js');
		$this->context->controller->addJs($this->_path.'views/js/frontend/jquery.prettyPhoto.js');
		$this->context->controller->addJs($this->_path.'views/js/frontend/jquery.lazyload.js');
		
		$this->context->controller->addJs($this->_path.'views/js/frontend/jquery.easing.js');
		...
		$this->context->controller->addJs($this->_path.'views/js/frontend/jquery.touchSwipe.js');
	...
	public function hookDisplayFooter()
	{
		...
		{		
			...
			$this->smarty->assign(array(
				...
				'page_name' => $page = $this->context->controller->php_self
			));
	...
	public function saveCSS()
	{
		...
		if($box_mode == 1)
		{	
			$mystyle .= '.box-mode #page{	position: relative; width: 1200px;   box-shadow: 0 0 8px #666666;    margin: 0 auto;}';
		}
		$file = _PS_MODULE_DIR_.$this->name.'/views/css/config_'.$id_shop.'.css';
