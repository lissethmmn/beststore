...
function showResultChooseFont(id,classE)
{
	if($("#" + id).val() != "")
	{
		$('head').append('<link id="link_' + id + '" rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=' + $("#" + id).val() + '">');
		$.cookie(''+ id +'',$("#" + id).val());
...
jQuery(document).ready(function($) {
	...
	var styleTextbox = '<style id="setconfig">.box-mode #page{	position: relative; width: 1200px;   box-shadow: 0 0 8px #666666;    margin: 0 auto;}</style>';
	if($.cookie('mode_css'))
	{
