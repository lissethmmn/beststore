...
<div id="search_block_top">
	<form id="searchbox" method="get" action="{$search_controller_url|escape:'html':'UTF-8'}">
		...
		<input class="search_query form-control input-white" type="text" id="search_query_top" name="s" placeholder="{l s='Search entire store...' mod='wtblocksearch'}" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
